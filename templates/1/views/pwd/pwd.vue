      ...
      <div class="view">
        <div class="resetPwd">
          ...
          <div id="resetPwd">
            ...
            <input type="hidden" id="scene" name="scene" value="nvc_login">
            <div class="main">
              ...
              <ul>
                ...
                <li>
                  ...
                  <prompt :top="-12" v-show="captchaBol>0&&index==2">
              ...
              <button class="bnt" @click="reset">{{$t('bnt.reset')}}</button>
            </div>
          </div>
        ...
        .catch(res => {
          if (res.message === "credential.doesnot.exist") {
            ...
            if (err.includes("credential.doesnot.exist")) {
              this.$toast(
                "err",
                this.$t(`message.credential_doesnot_exist`),
                2
              );
            } else {
