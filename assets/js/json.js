...
let verifyState = {
  UNREAL: [
    'personal.unCertification',
    'icon-zhuyi',
    'personal.unCertificationTxt',
    'personal.goCertification'
  ],
  AUDIT: ['personal.review', 'icon-hb_icon_audit1', 'personal.reviewTxt'],
  REAL: [
    'personal.certified',
    'icon-zhengquetishi green',
    'personal.certifiedTxt'
  ],
  REFUSED: [
    'personal.refusedL',
    'icon-guanbi1 red',
    'personal.refusedLTxt',
    'personal.update'
  ],
  PRIMARY: [
    'personal.unCertification',
...
let historys = {
  ...
  TRADE_PASSWORD_GOOGLECODE_MSG_EMAIL:
    'personal.history.TRADE_PASSWORD_GOOGLECODE_MSG_EMAIL',
